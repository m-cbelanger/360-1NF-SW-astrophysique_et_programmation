...
Ceci est un rappel des notions vues en *programmation en sciences* à la session 2. 

Dans les notes ci-dessous, les notions sont résumées et on consolide avec des exercices dirigés ou autonome, certains à remettre. 
...
- les outils d'IA sont aussi de bons alliés pour s'inspirer, se faire expliquer et apprendre des syntaxes simples rapidement.
...
Pour afficher un graphe, plusieurs éléments sont utiles pour afficher des relations (ou fonctions) avec les paramètres esthétiques désirés.
